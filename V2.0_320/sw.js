...
var CACHE_NAME = 'alert-cube-v20-20260918-layout';
var PRECACHE = [
  './config/site-config.js?v=20260918-layout',
  './scripts/alert-cube-core.js?v=20260918-layout',
  './scripts/alert-cube-runtime.js?v=20260918-layout',
  './scripts/alert-cube-typhoon.js?v=20260918-layout',
  './scripts/jma-warning-kinds.js?v=20260918-layout',
  './scripts/warning-hero.js?v=20260918-layout',
  './styles/white-hero.css?v=20260918-layout',
  './styles/color-hero.css?v=20260918-layout',
  './styles/fonts.css?v=20260918-layout',
  './images/logo.svg?v=20260918-layout',
